...
import com.fleot.app.repository.DriverRepository;
...
public class DriverResourceIT {
    ...
    private static final byte[] UPDATED_LICENSE_IMAGE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_NID_IMAGE = TestUtil.createByteArray(1, "1");
