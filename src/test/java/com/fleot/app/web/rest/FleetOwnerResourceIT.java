...
import com.fleot.app.domain.enumeration.Gender;
/**
 * Integration tests for the {@Link FleetOwnerResource} REST controller.
 */
@SpringBootTest(classes = FleotappApp.class)
public class FleetOwnerResourceIT {
    ...
    public void setup() {
        ...
        final FleetOwnerResource fleetOwnerResource = new FleetOwnerResource(fleetOwnerRepository);
     ...
     * if they test an entity which requires the current entity.
     */
    public static FleetOwner createUpdatedEntity(EntityManager em) {
        FleetOwner fleetOwner = new FleetOwner()
