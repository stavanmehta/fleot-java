...
export class CarTypeDetail extends React.Component<ICarTypeDetailProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  render() {
    const { carTypeEntity } = this.props;
    return (
      <Row>
        <Col md="8">
          <h2>
          ...
          <dl className="jh-entity-details">
            ...
            <dd>{carTypeEntity.typeName}</dd>
          </dl>
          <Button tag={Link} to="/entity/car-type" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>
          &nbsp;
          <Button tag={Link} to={`/entity/car-type/${carTypeEntity.id}/edit`} replace color="primary">
